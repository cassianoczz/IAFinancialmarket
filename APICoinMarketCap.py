...
## Iterate through top 1 coins and pull names into a list
base_url = "https://api.coinmarketcap.com/v1/ticker/?limit=1"
...
base_url = "https://coinmarketcap.com/currencies/{0}/historical-data/?start=20120901&end=" + end_date ; 
def get_data(coin):
